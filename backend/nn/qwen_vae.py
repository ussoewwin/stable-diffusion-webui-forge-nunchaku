# QwenImage VAE (based on WAN VAE structure)
# Reference: https://github.com/QwenLM/Qwen-Image
# Original WAN VAE: https://github.com/comfyanonymous/ComfyUI/blob/v0.3.64/comfy/ldm/wan/vae.py
...
class Resample(nn.Module):
    ...
    def forward(self, x, feat_cache=None, feat_idx=[0]):
        ...
        elif self.mode == "upsample2d" or self.mode == "downsample2d":
            x = rearrange(x, "b c t h w -> (b t) c h w")
            x = self.resample(x)
            x = rearrange(x, "(b t) c h w -> b c t h w", t=t)
...
class QwenImageVAE(nn.Module, ConfigMixin):
