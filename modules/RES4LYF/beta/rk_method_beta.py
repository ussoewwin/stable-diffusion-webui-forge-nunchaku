...
class RK_Method_Beta:
    def __init__(self,
        ...
        if model_sampling is None:
            if hasattr(model, "inner_model") and hasattr(model.inner_model, "inner_model") and hasattr(model.inner_model.inner_model, "model_sampling"):
                model_sampling = model.inner_model.inner_model.model_sampling
                model_sampling_path = "model.inner_model.inner_model.model_sampling (ComfyUI BaseModel)"
        
        if model_sampling is None:
            # Try model.inner_model.model_sampling (if ForgeScheduleLinker has it directly)
            if hasattr(model, "inner_model") and hasattr(model.inner_model, "model_sampling"):
                model_sampling = model.inner_model.model_sampling
                model_sampling_path = "model.inner_model.model_sampling"
        
        if model_sampling is None:
            # Try model.model.model_sampling (fallback)
        ...
        if model_sampling is None:
            ...
            raise AttributeError(f"model_sampling not found. Model type: {model_type_str}. Tried: forge_objects.unet.model.model_sampling (Forge), model.inner_model.inner_model.model_sampling (ComfyUI BaseModel), model.inner_model.model_sampling, model.model.model_sampling")
