...
def is_RF_model(model):
    ...
    # Check both comfy.model_sampling.CONST and backend.modules.k_model.CONST
    # ModelSamplingFluxWithConst uses backend.modules.k_model.CONST
    try:
        from backend.modules.k_model import CONST as BackendCONST
    except ImportError:
        BackendCONST = None
    return isinstance(modelsampling, model_sampling.CONST) or (BackendCONST is not None and isinstance(modelsampling, BackendCONST))
